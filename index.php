...
//  $c=$_POST['Category'];
 ...
 $sql="select * from if0_34735189_lms.user where RollNo='$u'";
...
if(isset($_POST['signup']))
{
	...
	$sql="insert into if0_34735189_lms.user (Name,Type,Category,RollNo,EmailId,MobNo,Password) values ('$name','$type','$category','$rollno','$email','$mobno','$password')";
...
<!-- Developer 4 -->
                <div class="col">
                    <div class="developer-card">
                        <div class="image-wrapper">
                            <img src="images/sumitpic.jpg" alt="Developer 4">
                        </div>
