                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id = "tables">
                                  ...
                                  <tbody>
                                    <?php
                            $sql="select * from if0_34735189_lms.record,if0_34735189_lms.book,if0_34735189_lms.renew where renew.BookId=book.BookId and renew.RollNo=record.RollNo and renew.BookId=record.BookId";
