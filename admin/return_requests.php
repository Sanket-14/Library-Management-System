                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id = "tables">
                                  ...
                                  <tbody>
                                    <?php
                            $sql="select return.BookId,return.RollNo,Title,datediff(curdate(),Due_Date) as x from if0_34735189_lms.return,if0_34735189_lms.book,if0_34735189_lms.record where return.BookId=book.BookId and return.BookId=record.BookId and return.RollNo=record.RollNo";
