                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <?php
                                    $bookid = $_GET['id'];
                                    $sql = "select * from if0_34735189_lms.book where Bookid='$bookid'";
...
$sql1="update if0_34735189_lms.book set Title='$name', Publisher='$publisher', Year='$year', Availability='$avail' where BookId='$bookid'";
