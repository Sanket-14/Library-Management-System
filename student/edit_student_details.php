                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                $sql="select * from if0_34735189_lms.user where RollNo='$rollno'";
                                ...
                                <form class="form-horizontal row-fluid" action="edit_student_details.php?id=<?php echo $rollno ?>" method="post">
                                    ...
                                    <div class="control-group">
                                            <label class="control-label" for="Category"><b>Role:</b></label>
                                            <div class="controls">
...
$sql1="update if0_34735189_lms.user set Name='$name', Category='$category', EmailId='$email', MobNo='$mobno', Password='$pswd' where RollNo='$rollno'";
